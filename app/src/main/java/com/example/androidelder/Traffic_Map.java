...
public class Traffic_Map extends AppCompatActivity implements OnMapReadyCallback, GoogleMap.OnMarkerClickListener {
    GoogleMap gMap;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        name = (TextView)findViewById(R.id.traff_map_name);
        name.setText(store);

        mapFragment = (SupportMapFragment) getSupportFragmentManager()
                .findFragmentById(R.id.traffic_map2);
