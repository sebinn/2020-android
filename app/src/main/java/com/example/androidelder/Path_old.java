...
public class Path_old extends AppCompatActivity implements OnMapReadyCallback, GoogleMap.OnMarkerClickListener {
    Spinner spinner;
...
//        mapFrag.getMapAsync(this);
        ...
        final Cursor cursor;
        cursor = sqlDB.rawQuery("SELECT * From Prefer_elder;", null);
        cursor.moveToFirst();

        int count = cursor.getCount();
        listView1 = (ListView)findViewById(R.id.path_list_all);
        ...
        //이미지 버튼
        imgbtn = (ImageButton)findViewById(R.id.search_icon_path);
        imgbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                editText = (EditText)findViewById(R.id.search_path);
                    ...
                    imgbtn.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            ...
                            if(text.length() > 0){
                                sqlDB = myHelper.getReadableDatabase();
                                final Cursor cursor;
                                cursor = sqlDB.rawQuery("SELECT * From Prefer_elder WHERE name LIKE '%" + text + "%'", null);
                                cursor.moveToFirst();

                                int count = cursor.getCount();
                                listView2 = (ListView)findViewById(R.id.path_list);
                                ...
                                listView2.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                    ...
                                    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                                        ...
                                        sqlDB = myHelper.getReadableDatabase();
                                        Cursor cursor;
                                        cursor = sqlDB.rawQuery("SELECT * FROM Prefer_elder WHERE name = '"+ arrayList2.get(i) + "';", null);
                                        cursor.moveToFirst();
                                        ...
                                        Intent intent = new Intent(getApplicationContext(), Path_Detail.class);
        ...
        listView1.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                sqlDB = myHelper.getReadableDatabase();
                Cursor cursor;
                cursor = sqlDB.rawQuery("SELECT * FROM Prefer_elder WHERE name = '"+ arrayList1.get(i) + "';", null);
                cursor.moveToFirst();
